...
public class ExtClock extends Clock
{
   ...
   {
      if (otherClock instanceof ExtClock) {
         ExtClock otherExtClock = (ExtClock)otherClock;

         return (super.equals(otherExtClock) && _zone == otherExtClock._zone);
      }
   ...
   public void printTime()
   {
      ...
      System.out.println(" " + _zoneToString(_zone));
   }
